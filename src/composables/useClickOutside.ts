...
const KEEP_SELECTION =
  '[data-card],[data-taskid],[data-rowtask],[data-rowgroup],[data-issuerow],[data-dd],input,textarea,select,label'
...
export function useClickOutside(): void {
  ...
  function onPointerDown(e: PointerEvent): void {
    ...
    if (popupOpen && !target?.closest('[data-dd]')) ui.closeAllPopups()
